...
//  bmobyios
//
//  Created by Oulachyov  on 10/13/16.
//  Copyright © 2016 bmoby. All rights reserved.
//

import UIKit

class LGHorizontalLinearFlowLayout: UICollectionViewFlowLayout {
    private var lastCollectionViewSize: CGSize = CGSizeZero
    internal var scalingOffset: CGFloat = 110
    internal var minimumScaleFactor: CGFloat = 0.5
    internal var scaleItems: Bool = true
    ...
    override internal func invalidateLayoutWithContext(context: UICollectionViewLayoutInvalidationContext) {
    ...
    internal override func targetContentOffsetForProposedContentOffset(proposedContentOffset: CGPoint, withScrollingVelocity velocity: CGPoint) -> CGPoint {
        if self.collectionView == nil {
    ...
    internal override func shouldInvalidateLayoutForBoundsChange(newBounds: CGRect) -> Bool {
        return true
    }
